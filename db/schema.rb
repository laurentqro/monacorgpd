...
ActiveRecord::Schema[8.1].define(version: 2025_10_10_083038) do
  ...
  create_table "answers", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["answer_value"], name: "idx_answers_value_gin", using: :gin
    t.index ["question_id"], name: "index_answers_on_question_id"
    t.index ["response_id", "question_id"], name: "idx_answers_response_question", unique: true
  ...
  create_table "audit_sessions", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["account_id", "created_at"], name: "idx_audit_sessions_account_created"
    t.index ["account_id", "status"], name: "idx_audit_sessions_account_status"
    t.index ["account_id"], name: "index_audit_sessions_on_account_id"
    t.index ["response_id"], name: "index_audit_sessions_on_response_id"
  end
  ...
  create_table "compliance_area_scores", force: :cascade do |t|
    ...
    t.decimal "score", precision: 5, scale: 2
    t.datetime "updated_at", default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.index ["audit_session_id", "compliance_area_id"], name: "idx_compliance_area_scores_unique", unique: true
    t.index ["audit_session_id"], name: "index_compliance_area_scores_on_audit_session_id"
  ...
  create_table "compliance_areas", force: :cascade do |t|
    ...
    t.datetime "updated_at", default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.index ["code"], name: "idx_compliance_areas_code", unique: true
  end
  ...
  create_table "logic_rules", force: :cascade do |t|
    ...
    t.datetime "updated_at", default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.index ["source_question_id"], name: "idx_logic_rules_source"
    t.index ["source_question_id"], name: "index_logic_rules_on_source_question_id"
    t.index ["target_section_id"], name: "idx_logic_rules_target_section"
  ...
  create_table "questionnaires", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["account_id", "created_at"], name: "idx_questionnaires_account_created"
    t.index ["account_id", "status"], name: "idx_questionnaires_account_status", where: "(deleted_at IS NULL)"
  ...
  create_table "questions", force: :cascade do |t|
    ...
    t.index ["section_id", "order_index"], name: "idx_questions_order"
    t.index ["section_id"], name: "index_questions_on_section_id"
    t.index ["settings"], name: "idx_questions_settings_gin", using: :gin
  end
  ...
  create_table "responses", force: :cascade do |t|
    ...
    t.integer "status", default: 0, null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "created_at"], name: "idx_responses_account_created"
    t.index ["account_id", "status"], name: "idx_responses_account_status"
  ...
  create_table "sections", force: :cascade do |t|
    ...
    t.string "title", limit: 500, null: false
    t.datetime "updated_at", null: false
    t.index ["questionnaire_id", "order_index"], name: "idx_sections_order"
  ...
  add_foreign_key "audit_sessions", "accounts", on_delete: :cascade
  add_foreign_key "audit_sessions", "responses", on_delete: :cascade
  add_foreign_key "compliance_area_scores", "audit_sessions", on_delete: :cascade
  add_foreign_key "compliance_area_scores", "compliance_areas", on_delete: :cascade
  add_foreign_key "logic_rules", "questions", column: "source_question_id", on_delete: :cascade
  add_foreign_key "logic_rules", "sections", column: "target_section_id", on_delete: :cascade
  add_foreign_key "pay_charges", "pay_customers", column: "customer_id"
  add_foreign_key "pay_payment_methods", "pay_customers", column: "customer_id"
  add_foreign_key "pay_subscriptions", "pay_customers", column: "customer_id"
  add_foreign_key "questionnaires", "accounts", on_delete: :cascade
  add_foreign_key "questionnaires", "users", column: "creator_id"
  add_foreign_key "questions", "sections", on_delete: :cascade
  add_foreign_key "responses", "accounts", on_delete: :cascade
  add_foreign_key "responses", "questionnaires", on_delete: :cascade
  add_foreign_key "responses", "users", column: "respondent_id", on_delete: :nullify
  add_foreign_key "sections", "questionnaires", on_delete: :cascade
end
