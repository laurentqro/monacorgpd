...
class ComplianceAreaScoreTest < ActiveSupport::TestCase
  def setup
    @score = compliance_area_scores(:lawfulness_score)
  end
  ...
  test "should enforce uniqueness of compliance_area per audit_session" do
    duplicate = ComplianceAreaScore.new(
  ...
  test "should belong to audit_session" do
    ...
    assert_equal audit_sessions(:completed_audit), @score.audit_session
  end

  test "should belong to compliance_area" do
    assert_respond_to @score, :compliance_area
    assert_equal compliance_areas(:lawfulness), @score.compliance_area
  end

  # Scopes
  test "should scope by audit_session" do
    results = ComplianceAreaScore.for_audit_session(audit_sessions(:completed_audit))
    assert_includes results, @score
  end

  test "should scope by compliance_area" do
    results = ComplianceAreaScore.for_compliance_area(compliance_areas(:lawfulness))
    assert_includes results, @score
  end

  test "should scope scored records" do
    results = ComplianceAreaScore.scored
