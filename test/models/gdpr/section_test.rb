...
class Gdpr::SectionTest < ActiveSupport::TestCase
  def setup
    @section = gdpr_sections(:section_one)
  end
  ...
  test "should belong to questionnaire" do
    ...
    assert_equal gdpr_questionnaires(:draft_questionnaire), @section.questionnaire
  end
  ...
  test "should destroy dependent questions" do
    assert_difference "Gdpr::Question.count", -@section.questions.count do
      @section.destroy
    end
  end
  ...
  test "should scope ordered sections" do
    results = Gdpr::Section.ordered
    assert_equal results.first.order_index, results.minimum(:order_index)
  end

  test "should scope by questionnaire" do
    results = Gdpr::Section.for_questionnaire(gdpr_questionnaires(:draft_questionnaire))
    assert_includes results, @section
    assert_not_includes results, gdpr_sections(:published_section)
  end

  # Auto order_index
  test "should auto-set order_index on create" do
    new_section = Gdpr::Section.new(
