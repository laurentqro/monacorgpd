...
class Gdpr::ComplianceAreaTest < ActiveSupport::TestCase
  def setup
    @compliance_area = gdpr_compliance_areas(:lawfulness)
  end
  ...
  test "should enforce unique code" do
    duplicate = Gdpr::ComplianceArea.new(
      name: "Duplicate",
