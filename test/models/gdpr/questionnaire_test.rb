...
class Gdpr::QuestionnaireTest < ActiveSupport::TestCase
  def setup
    @questionnaire = gdpr_questionnaires(:draft_questionnaire)
  end
  ...
  test "should have many sections" do
    ...
    assert_includes @questionnaire.sections, gdpr_sections(:section_one)
  end
  ...
  test "should destroy dependent sections" do
    assert_difference "Gdpr::Section.count", -@questionnaire.sections.count do
  ...
  test "should scope by account" do
    results = Gdpr::Questionnaire.for_account(accounts(:one))
    assert_includes results, @questionnaire
    assert_not_includes results, gdpr_questionnaires(:account_two_questionnaire)
  end

  test "should scope active questionnaires" do
    results = Gdpr::Questionnaire.active
    assert_includes results, @questionnaire
    assert_not_includes results, gdpr_questionnaires(:deleted_questionnaire)
  end

  test "should scope by status" do
    results = Gdpr::Questionnaire.by_status(:draft)
    assert_includes results, @questionnaire
    assert_not_includes results, gdpr_questionnaires(:published_questionnaire)
  end
