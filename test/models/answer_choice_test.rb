...
class AnswerChoiceTest < ActiveSupport::TestCase
  ...
  test "should belong to question" do
    ...
    assert_equal questions(:single_choice_question), @answer_choice.question
  end

  # Scopes
  test "should scope ordered answer_choices" do
    results = AnswerChoice.ordered
    assert_equal results.first.order_index, results.minimum(:order_index)
  end

  test "should scope by question" do
    results = AnswerChoice.for_question(questions(:single_choice_question))
    assert_includes results, @answer_choice
    assert_not_includes results, answer_choices(:multiple_choice_one)
  end

  # Auto order_index
  test "should auto-set order_index on create" do
    new_choice = AnswerChoice.new(
