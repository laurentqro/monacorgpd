...
class AnswerTest < ActiveSupport::TestCase
  def setup
    @answer = answers(:single_choice_answer)
  end
  ...
  test "calculate_score should calculate score for single choice" do
    ...
    choice = answer_choices(:choice_two)
