...
class AuditSessionTest < ActiveSupport::TestCase
  def setup
    @audit_session = audit_sessions(:draft_audit)
  end
  ...
  test "should belong to response" do
    ...
    assert_equal responses(:completed_response), @audit_session.response
  end
